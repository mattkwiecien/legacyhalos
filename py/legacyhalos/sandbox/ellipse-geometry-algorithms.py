...
geo = EllipseGeometry(
    x0=props2.xpeak,
    y0=props2.ypeak,
    sma=props2.majoraxis,
    eps=props2.eps,
    pa=np.radians(props2.pa - 90),
)
...
).plot(color="blue", lw=1, alpha=0.75)
EllipticalAperture(
    (props2.xpeak, props2.ypeak),
    props2.majoraxis,
    props2.majoraxis * (1 - props2.eps),
    np.radians(props2.pa - 90),
).plot(color="red", lw=1, alpha=0.75)
