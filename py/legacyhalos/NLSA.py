...
def make_html(
    ...
    for ii, onegal in enumerate(np.atleast_1d(sample)):
        ...
        with open(htmlfile, "w") as html:
            ...
            html.write(
                """<p>From left to right: GALEX (FUV/NUV), DESI Legacy Surveys (grz), and unWISE (W1/W2)
            ...
            html.write(
                """<p>From left to right: data; model image of all sources except the central, resolved galaxy;
            ...
            html.write(
                '<td width="100%"><a href="{0}"><img src="{0}" alt="Missing file {0}" height="auto" width="100%"></a></td>\n'.format(
                    pngfile
                )
            )
            html.write("<td></td>\n")
